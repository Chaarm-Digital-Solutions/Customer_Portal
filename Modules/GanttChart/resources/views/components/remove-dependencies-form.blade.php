...
<div id="controls-container" class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md md:w-1/4">
    <form action="{{ route('task.dependency.remove') }}" id="add-task" method="POST" class="space-y-4">
        ...
        <!-- Task Name -->
        <div>
            <label for="task-name" class="block text-sm font-medium text-gray-700">From the task...</label>
        ...
        <!-- Description -->
        <div>
            <label for="task-dependency" class="block text-sm font-medium text-gray-700">...remove this dependency:</label>
